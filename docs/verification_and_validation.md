...
The 0.75/0.5 order gates are project-defined regression gates for this smooth benchmark; they are not universal CFD accuracy thresholds and are not attributed to an external experiment or standard.
...
These 0.02/0.05 limits are likewise project-defined sensitivity/regression gates, not literature-derived physical uncertainty bounds.
