...
Current stage: **P6.1 - Wall Friction Source Model**.
...
P6.1 adds the independent prescribed Darcy-factor wall-friction momentum source. Its hydraulic diameter and Darcy friction factor are explicit inputs; it is not yet integrated into `solve_quasi_1d`. Heat transfer remains P6.2 work.
...
P6.2, wall heat transfer, is the next planned stage.
