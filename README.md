...
Current stage: **P6.2 - Wall Heat-Transfer Source Model**.
...
P6.1 adds the independent prescribed Darcy-factor wall-friction momentum source. P6.2 adds the independent prescribed wall-heat-flux energy source: positive heat flux adds energy to the gas and negative heat flux removes it. Hydraulic diameter is an explicit input for both sources. Neither source is yet integrated into `solve_quasi_1d`; composition and integration are P6.3 work.
...
P6.3, source composition and solver integration, is the next planned stage.
