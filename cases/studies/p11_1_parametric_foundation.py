...
METRIC_DEFINITION_REGISTRY = {
    ...
    "mass_flow_relative_span": {"symbol": "delta_mdot_rel", "units": "1", "definition": "(max_i mass_flow_i - min_i mass_flow_i) / abs(mean_i mass_flow_i)", "interpretation": "relative span of cell-centered mass flow", "hard_gate": False, "scope": "controlled P11.1 framework case"},
